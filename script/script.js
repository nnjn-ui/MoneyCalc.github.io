...
const generateId = () => `gloDeni${Math.round(Math.random() * 1e8).toString(16)}`

const 
totalBalance = document.querySelector('.total__balance'),
totalMoneyIncome = document.querySelector('.total__money-income'),
totalMoneyExspenses = document.querySelector('.total__money-expenses'),
...
const updateBalance = () => {
    ...
    totalMoneyExspenses.textContent = resultExpenses  + '₽';
